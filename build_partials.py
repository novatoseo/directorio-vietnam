...
def header_html(base='/'):
    ...
    base='' se normaliza a '/' para evitar href="" (que apunta a la URL actual)."""
    b = base if base else '/'
  ...
  <a class="announcement-bar" href="https://vanec.vn/english/" target="_blank" rel="nofollow sponsored noopener" data-action="announcement">
